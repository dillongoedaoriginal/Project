...
<br><h1 style="text-align: center; background-color: #9370db;"><b>Lecturers Information</b></h1><br><br>
@foreach($dis as $x)
  <div class="column">
    <img src="{{ asset('imag/profile.png') }}" alt="Snow" style="width:40%"> <br><b>Name:</b> {{$x['name']}}<br><b>Email:</b> {{$x['lect_email']}}<br><b>Phone Number:</b> {{$x['lect_phone']}}<br><b>Room Number:</b> {{$x['lect_room']}}
  </div>
@endforeach 
</div>
